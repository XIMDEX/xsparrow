...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="headerBackgroundColor">
		<xsl:choose>
			<xsl:when test="not (//xsparrow-theme/main/header/@background-color) or 
				//xsparrow-theme/main/header/@background-color = ''">
				transparent
			</xsl:when>
			<xsl:otherwise>
				<xsl:value-of select="//xsparrow-theme/main/header/@background-color"/>
			</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="headerFontColor">
		<xsl:choose>
			<xsl:when test="not (//xsparrow-theme/main/header/@font-color) or 
				//xsparrow-theme/main/header/@font-color = ''">
				transparent
			</xsl:when>
			<xsl:otherwise>
				<xsl:value-of select="//xsparrow-theme/main/header/@font-color"/>
			</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="headerBorder">
		<xsl:choose>
			<xsl:when test="not (//xsparrow-theme/main/header/@border) or 
				//xsparrow-theme/main/header/@border='' or
				//xsparrow-theme/main/header/@border='None'">
				<xsl:text>border:0px solid</xsl:text>		     
			</xsl:when>
			<xsl:when test="//xsparrow-theme/main/config-header/@border='All'">
				<xsl:text>border:1px solid</xsl:text>
			</xsl:when>
			<xsl:when test="contains(//xsparrow-theme/main/config-header/@border,'Top')">
				<xsl:text>border-top:1px solid</xsl:text>
			</xsl:when>
			<xsl:when test="contains(//xsparrow-theme/main/config-header/@border,'Left')">
				<xsl:text>border-left:1px solid</xsl:text>
			</xsl:when>
			<xsl:when test="contains(//xsparrow-theme/main/config-header/@border,'Bottom')">
				<xsl:text>border-bottom:1px solid</xsl:text>
			</xsl:when>
			<xsl:when test="contains(//xsparrow-theme/main/config-header/@border,'Right')">
		...
		<xsl:variable name="headerBorderColor">
			<xsl:choose>
				<xsl:when test="not (//xsparrow-theme/main/header/@border-color) 
					or //xsparrow-theme/main/header/@border-color=''">
				</xsl:when>
				<xsl:otherwise>
					<xsl:text>border-color: </xsl:text> <xsl:value-of select="//xsparrow-theme/main/header/@border-color"/>
					<xsl:text>;</xsl:text>
				</xsl:otherwise>
			</xsl:choose>
		</xsl:variable> 
		...
		<xsl:variable name="headerTitleFontColor">
			<xsl:choose>
				<xsl:when test="not (//xsparrow-theme/main/header/header-title/@font-color) or 
					//xsparrow-theme/main/header/header-title/@font-color = ''">
					inherit
				</xsl:when>
				<xsl:otherwise>
					<xsl:value-of select="//xsparrow-theme/main/header/header-title/@font-color"/>
				</xsl:otherwise>
			</xsl:choose>
		</xsl:variable>
		<xsl:variable name="headerTitleFontSize">
			<xsl:choose>
				<xsl:when test="not (//xsparrow-theme/main/header/header-title/@font-size) or //xsparrow-theme/main/header/header-title/@font-size = ''">
					<xsl:text>auto</xsl:text>
				</xsl:when>
				<xsl:otherwise>
					<xsl:value-of select="//xsparrow-theme/main/header/header-title/@font-size"/>
				</xsl:otherwise>
			</xsl:choose>
		</xsl:variable>
		...
		<xsl:variable name="headerTitleAlign">
			<xsl:choose>
				<xsl:when test="not (//xsparrow-theme/main/header/header-title/@align) or //xsparrow-theme/main/header/header-title/@align = ''">
					<xsl:text>left</xsl:text>
				</xsl:when>
				<xsl:otherwise>
					<xsl:value-of select="//xsparrow-theme/main/header/header-title/@align"/>
				</xsl:otherwise>
			</xsl:choose>
		</xsl:variable>
		...
		<xsl:variable name="headerSubtitleFontColor">
			<xsl:choose>
				<xsl:when test="not (//xsparrow-theme/main/header/header-subtitle/@font-color) or //xsparrow-theme/main/header/header-subtitle/@font-color = ''">
					inherit
				</xsl:when>
				<xsl:otherwise>
					<xsl:value-of select="//xsparrow-theme/main/header/header-subtitle/@font-color"/>
				</xsl:otherwise>
			</xsl:choose>
		</xsl:variable>
		<xsl:variable name="headerSubtitleFontSize">
			<xsl:choose>
				<xsl:when test="not (//xsparrow-theme/main/header/header-subtitle/@font-size) or //xsparrow-theme/main/header/header-subtitle/@font-size = ''">
					<xsl:text>auto</xsl:text>
				</xsl:when>
				<xsl:otherwise>
					<xsl:value-of select="//xsparrow-theme/main/header/header-subtitle/@font-size"/>
				</xsl:otherwise>
			</xsl:choose>
		</xsl:variable>
		...
		<xsl:variable name="headerSubtitleAlign">
			<xsl:choose>
				<xsl:when test="not (//xsparrow-theme/main/header/header-subtitle/@align) or //xsparrow-theme/main/header/header-subtitle/@align = ''">
					<xsl:text>inherit</xsl:text>
				</xsl:when>
				<xsl:otherwise>
					<xsl:value-of select="//xsparrow-theme/main/header/header-subtitle/@align"/>
				</xsl:otherwise>
			</xsl:choose>
		</xsl:variable>                  
